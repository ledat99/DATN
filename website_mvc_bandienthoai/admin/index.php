    ...
    <div class="dashboard-cards">
      <div class="row">
        ...
        if($revenue){
          ...
          while($result=$revenue->fetch_assoc()){
          ...
          <div class="card horizontal cardIcon waves-effect waves-dark">
            ...
            <div class="card-stacked red">
              <div class="card-content">
                <h3><?php echo $fm->format_currency($result['revenue']) . '' . 'đ'; ?></h3>
              </div>
        ...
        $ct = new cart();
        $fm = new format();
        $count_order =$ct->countOrder();
        if($count_order){
       
          while($result_count_order=$count_order->fetch_assoc()){
            ?>
          ...
          <div class="card horizontal cardIcon waves-effect waves-dark">
            ...
            <div class="card-stacked orange">
              <div class="card-content">
                <h3><?php echo $result_count_order['count']; ?></h3>
              </div>
              <div class="card-action">
                <strong>SALES</strong>
              </div>
        ...
        if($count_product){
          ...
          while($result_count_product=$count_product->fetch_assoc()){
            ?>
          ...
          <div class="card horizontal cardIcon waves-effect waves-dark">
            ...
            <div class="card-stacked blue">
              <div class="card-content">
                <h3><?php echo $result_count_product['count']; ?></h3>
              </div>
              <div class="card-action">
